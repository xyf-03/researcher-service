...
| `OPENCLAW_IMAGE` | `ghcr.io/acautomata/researcher-service/openclaw:2026.9.4-browser` | 镜像 tag（派生镜像 issue #588：pdftotext + wiki/workspace 骨架，ADR 0013；可覆盖回官方基线）。**生产禁浮动 tag**：无 tag / `:latest` 启动即 fail-fast（#695） |
